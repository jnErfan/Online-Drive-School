...
const About = () => {
    return (
        <div className="container">
            ...
            <img width="700px" className="rounded-pill mt-5 mb-5" src="https://images.unsplash.com/photo-1521410843026-323be9ead002?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8ZHJpdmluZ3xlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&w=1000&q=80" alt="" />
